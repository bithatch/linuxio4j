/*
 * 
 * Based on Python IOCTL (https://python-ioctl.readthedocs.io/en/stable/_modules/ioctl/linux.html#IOC)
 * 
 * Parts of this taken from Maven os-maven-plugin  (https://github.com/trustin/os-maven-plugin):-
 * 
